...
namespace CounterEvent
{
    ...
    class Counter2
    {
        ...
        // Events
        public event CounterEventHandler CounterStartHandler;
        public event CounterEventHandler CounterFinishHandler;
        public event CounterEventHandler CounterChangeHandler;
        ...
        public Counter2(int startValue = 0, int finishValue = 10, int stepValue = 1)
        {
